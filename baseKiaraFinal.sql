...
DROP TABLE IF EXISTS `libreriaaudio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `libreriaaudio` (
  `ruta_libreriaaudio` varchar(500) NOT NULL,
...
--
-- Dumping data for table `libreriaaudio`
--


DROP TABLE IF EXISTS `libreriafoto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `libreriafoto` (
  `ruta_libreriafoto` varchar(500) NOT NULL,
...
--
-- Dumping data for table `libreriafoto`
--
...
insert into cuento(titulo, descripcion, creditos, numero_paginas) values('La Hormiga Trabajadora', 'Ver la necesidad del otro y compartir. Ser solidario con los demás.', ' creado por: Mariana Morales', 4);
insert into cuento(titulo, descripcion, creditos, numero_paginas) values('Los Ratoncitos Desobedientes', 'Ver la importancia de la obediencia.', ' creado por: Manuel Mendieta', 4);
insert into cuento(titulo, descripcion, creditos, numero_paginas) values('Los Ositos Reboltosos', 'Ver la importancia del respeto y la disciplina.', ' creado por: Eva Moreno Montilla', 4);
